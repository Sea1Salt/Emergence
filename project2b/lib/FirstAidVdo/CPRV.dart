...
class CPRVideo extends StatefulWidget {
  @override
  _CPRVideoState createState() => _CPRVideoState();
}

class _CPRVideoState extends State<CPRVideo> {
      ...
      children: [
        ...
        Scaffold(
                ...
                return Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: const Color.fromARGB(255, 73, 224, 211),
          ...
          floatingActionButton: FloatingActionButton(
            ...
            backgroundColor: Color.fromARGB(255, 73, 224, 211),
            child: Icon(
