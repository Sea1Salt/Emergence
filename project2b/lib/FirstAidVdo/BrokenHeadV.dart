...
class BrokenHeadVideo extends StatefulWidget {
  @override
  _BrokenHeadVideoState createState() => _BrokenHeadVideoState();
}

class _BrokenHeadVideoState extends State<BrokenHeadVideo> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset('assets/images/BrokenHead.mp4');
                ...
                return Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: const Color.fromARGB(255, 224, 146, 73),
