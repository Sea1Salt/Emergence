...
class ScaldVideo extends StatefulWidget {
  @override
  _FaintVideoState createState() => _FaintVideoState();
}

class _FaintVideoState extends State<ScaldVideo> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset('assets/images/Scald.mp4');
                ...
                return Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: const Color.fromARGB(255, 141, 224, 73),
