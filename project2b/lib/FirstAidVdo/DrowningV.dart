...
class DrowningVideo extends StatefulWidget {
  @override
  _DrowningVideoState createState() => _DrowningVideoState();
}

class _DrowningVideoState extends State<DrowningVideo> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset('assets/images/Drowning.mp4');
                ...
                return Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: const Color.fromARGB(255, 73, 121, 224),
