...
class SeizureVideo extends StatefulWidget {
  @override
  _FaintVideoState createState() => _FaintVideoState();
}

class _FaintVideoState extends State<SeizureVideo> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset('assets/images/Seizures.mp4');
                ...
                return Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: const Color.fromARGB(255, 151, 73, 224),
