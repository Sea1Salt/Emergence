...
class BrokenArmVideo extends StatefulWidget {
  @override
  _BrokenArmVideoState createState() => _BrokenArmVideoState();
}

class _BrokenArmVideoState extends State<BrokenArmVideo> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        Scaffold(
          appBar: AppBar(
            title: Text('Broken arm and leg', style: TextStyle(color: Colors.white)),
                ...
                return Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: const Color.fromARGB(255, 224, 73, 73),
